...
EOF;
    ...
    public function testRenderWithLanguage()
    {
        $expected = <<<EOF
<script type="text/javascript">
function load_ivory_google_map_api () { google.load("maps", "3", {"language":"fr","other_params":"libraries=geometry,places&sensor=false"}); };
</script>
<script type="text/javascript" src="//www.google.com/jsapi?callback=load_ivory_google_map_api"></script>
...
EOF;
    ...
    public function testRenderWithCallback()
    {
        $expected = <<<EOF
<script type="text/javascript">
function load_ivory_google_map_api () { google.load("maps", "3", {"language":"en","other_params":"libraries=geometry,places&sensor=false", "callback": callback}); };
</script>
<script type="text/javascript" src="//www.google.com/jsapi?callback=load_ivory_google_map_api"></script>

EOF;

        $this->assertSame($expected, $this->apiHelper->render('en', 'callback'));
    }
...
EOF;
        ...
        $this->assertSame($expected, $this->apiHelper->render('en', null, array()));
    }
...
EOF;
        ...
        $this->assertSame($expected, $this->apiHelper->render('en', null, array('geometry')));
    }
...
EOF;
        ...
        $this->assertSame($expected, $this->apiHelper->render('en', null, array(), true));
    }
}
